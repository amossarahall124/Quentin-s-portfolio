          ...
          lg:text-[50px] font-extrabold text-lato italic text-center mt-2 ">My Projects </h1>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 justify-center items-center gap-4 mt-8  rounded-sm shadow-md  ">
              {ProjectList.map((project, idx) => {
                return (
                  <div className="flex  flex-col  bg-stone-800 justify-center items-center p-2 hover:scale-110 duration-200 cursor-pointer max-w-[500px] max-h-[500px] lg:w-[250px] w-[220px] ml-4 lg:ml-4 rounded-md shadow-md lg:hshadow-lg shadow-stone-600">
