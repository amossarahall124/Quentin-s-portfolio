...
const About = () => {
  return (
    ...
    <motion.div
      ...
      <div className='bg-main-100 max-w-[1500px] max-h-[1000px] w-[440px] h-[550px] lg:w-[1100px] lg:h-[580px] mt-40 ml-20 lg:mt-40 md:ml-24 md:w-[600px] lg:ml-72 border-4 border-slate-100 hover:border-blue-100 shadow-md duration-500 ease-out  relative '> 
